...
class BrushTicket(object):
    ...
    def send_mail(self, receiver_address, content):
        ...
        host = 'smtp.163.com'
        port = 25
        sender = '18986274954@163.com'  # 你的发件邮箱号码
        pwd = '123456'  # 不是登陆密码，是客户端授权密码
        # 发件信息
...
if __name__ == '__main__':
    ...
    receiver_email = 'gxcuizy@163.com'
